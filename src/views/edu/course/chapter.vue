      ...
      <el-form :model="video" label-width="120px">
        ...
        <el-form-item label="上传视频">
          <el-upload
            ...
            :file-list="fileList"
            :action="BASE_API+'/eduvod/video/uploadAliVod'"
            :limit="1"
            class="upload-demo">
...
export default {
  ...
  methods: {
    ...
    handleVodRemove(file, fileList) {
      console.log(file)
      vod.removeAliVideoById(this.video.videoSourceId)
        .then(response => {
          this.$message({
            type: 'success',
    ...
    removeVideo(videoId) {
      this.$confirm('此操作将永久删除该课时, 是否继续?', '提示', {
        ...
        // 调用删除的方法
        video.deleteVideoInfoById(videoId)
          .then(response => {
            this.$message({
              type: 'success',
              message: '删除成功!'
